...
return (
  ...
  <label htmlFor="user"></label>
    <input className="commentUser" placeholder="User Name" name="user" type='text' id='user' onChange={handleChange} value={comments.user}/>
    <label htmlFor="text"></label>
    <input className="commentText" placeholder="Comment" name="text" id="text" onChange={handleChange} value={comments.text}></input>
